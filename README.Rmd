...
I can't tell you how many times I've went through an auto-completion plugin only
to be ultimately and inevitably disappointed.
The common problems they all share are:
...
It takes less than twenty lines of code because that is all that is needed.
Here is how it works:

Omni-completion and tags in the current file
: If you are typing alphanumeric characters
File location completion
: If you are typing locations to files

That is how it **should** work.
Also, there are no configuration options because there does not need to be.
It is sensible by default.
